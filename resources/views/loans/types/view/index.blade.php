                            ...
                            @if($types)
                                @foreach($types as $key => $value)
                                    <tr class="c-table__row"> 
                                        ...
                                        <td class="c-table__cell"><b>{{ $value->type }}</b></td>  
                                        ...
                                        <td class="c-table__cell">
                                            <div class="c-dropdown dropdown">
                                                ...
                                                <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton21">
                                                    <a class="c-dropdown__item dropdown-item" href="{{ URL::route('loan_types_update',$value->id) }}">Update</a> 
                                                    <a class="confirm c-dropdown__item dropdown-item" href="{{ URL::route('loan_delete',$value->id) }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>  
                                    </tr> 
