    ...
    <div class="container-fluid" style="margin:1%; padding:1%; width:98%; margin-top: 2%; background-color: white;">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12" style="padding: 2%;"> 
                <form method="post" action="{{ URL::route('leaves_update_save',$data->id) }}"> 
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12 col-md-12 u-mb-medium">
                            <img src="{{ URL::asset('assets') }}/{{ $emp->photo }}" width="10%">
                        </div>
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                                <label class="c-field__label" for="input17">Employee ID</label>
                                <input class="c-input c-input--info" id="input17" type="text" readonly value="CYAN{{ date('Y',strtotime($emp->created_at)).'00000'.$emp->id }}">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                                <label class="c-field__label" for="input17">Full Name</label>
                                <input class="c-input c-input--info" id="input17" type="text" readonly value="{{ $emp->fname }} {{ $emp->mname }} {{ $emp->lname }}">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                                <label class="c-field__label" for="input17">Designation</label>
                                <input class="c-input c-input--info" id="input17" type="text" readonly value="{{ $emp->designation }}">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                            ...
                            <div class="c-form-field">
                                ...
                                <input class="c-input c-input--info" id="input17" type="date" required name="start" value="{{ $data->start }}">
                            </div>
                            <div class="c-form-field">
                                <label class="c-field__label" for="input17">End</label>
                                <input class="c-input c-input--info" id="input17" type="date" required name="end" value="{{ $data->end }}">
                            </div>
                        </div>
                        <div class="col-sm-8 col-md-8 u-mb-medium">
                            <div class="c-field">
                                <label class="c-field__label" for="input18">Notes</label>
                                <textarea class="c-input" rows="8" id="textarea5" required name="notes">{{ $data->notes }}</textarea>
                            </div>
                        </div> 
